...
namespace TJWCommon
{
    public class SQLiteHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                string text = @"Data Source=USER_DB\StuScoDB.db;Pooling=true;FailIfMissing=false";
                return text;
            }
        }
        ...
        public static IDataReader ExecuteReader(SQLiteCommand cmd, string commandText, SQLiteParameter[] paramList)
        {
        ...
        /// </remarks>  
        public static int ExecuteNonQuery(SQLiteTransaction transaction, string commandText, params  SQLiteParameter[] paramList)
        {
            ...
            using (SQLiteCommand cmd = transaction.Connection.CreateCommand())
            {
                cmd.CommandText = commandText;
                if (paramList != null)
                {
